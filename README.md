...
- Each major section has its own wrapper class to control total site width.<br><br>
    - `header-wrapper`<br>
    - `section-wrapper`<br>
    - `footer-wrapper`<br><br>
...
- The site uses svg icons in multiple places with a combination of a common<br>
  ...
  structure is used for captions.<br><br>
  - `icon`<br>
  - `[unique-class]`<br>
    - _example:_ `class="icon instagram"`<br><br>

## CSS

### style.css

- Contains CSS resets and default styles.<br><br>

### fonts.css

- Contains @font-face to import fonts from `/assets/fonts`.<br>
- Contains global font sizes and styles.<br>
- Contains individual font sizes and styles.<br><br>

### layout.css

- Contains grid layout and overall site structure.<br><br>

### state.css

- Contains styles for active, hover and focus states.<br><br>

### theme.css

- Contains styles that include colors, backgrounds and borders.<br><br>

### variables.css

- Contains global variable definitions separated by category.<br><br>
    - Site Colors.<br>
    - Site Dimensions.<br>
    - Font Colors.<br>
    - Font Dimensions.<br>
...
- Contains functions and event listeners for the following:<br><br>
